...
it would be more fun to reinvent the wheel (or in this case, reinvent the matrix and reinvent the fraction.)
This program is also handy for solving systems of equations since "pivoting" is the same thing as doing a step of Gaussian Elimination.